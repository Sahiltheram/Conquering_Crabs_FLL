...
def run5test (ev3, walter, left_motor, right_motor, attach_left_motor, attach_right_motor, gyro):
    ...
    walter.straight(-90)
    walter.stop()
    right_motor.run_angle(200, 75, Stop.HOLD, wait=True)
    ...
    attach_right_motor.run_until_stalled(-150, Stop.HOLD, duty_limit=70)
